    ...
    public partial class Form1 : Form
    {
        ...
        private void btnLogin_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                errorLogin.SetError(txtEmail, "Email");
                errorLogin.SetError(txtPassword, "Senha");

                errorLogin.SetError(btnLogin, "Email ou Senha Incorretos!");
            }
        }
        ...
        {
            Modal.ForgotPass fnw = new Modal.ForgotPass();
            this.Hide();
            fnw.Show();
        }
    }
